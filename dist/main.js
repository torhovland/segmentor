...
{
	if (region.J.A === region.Q.A)
	{
		return 'on line ' + region.J.A;
	}
	return 'on lines ' + region.J.A + ' through ' + region.Q.A;
}
...
var $author$project$Main$Model = F4(
	function (key, url, oauth, number) {
		return {V: key, w: number, az: oauth, aj: url};
	});
...
var $author$project$Main$Decrement = {$: 3};
var $author$project$Main$Increment = {$: 2};
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$href('https://www.strava.com/oauth/authorize?client_id=38457&response_type=code&redirect_uri=http://localhost:8080/exchange_token&approval_prompt=force&scope=read,activity:read&state=123')
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$src('images/btn_strava_connectwith_orange.svg')
									]),
								_List_Nil)
							]))
					])),
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$src('images/api_logo_pwrdBy_strava_horiz_light.svg')
							]),
						_List_Nil)
					]))
			]),
...
var $author$project$Main$main = $elm$browser$Browser$application(
	{ax: $author$project$Main$init, aA: $author$project$Main$UrlChanged, aB: $author$project$Main$LinkClicked, aE: $author$project$Main$subscriptions, aG: $author$project$Main$update, aH: $author$project$Main$view});
_Platform_export({'Main':{'init':$author$project$Main$main(
	A2(
		...
		A2($elm$json$Json$Decode$field, 'y', $elm$json$Json$Decode$float)))(0)}});}(this));